...
app_publisher = "Anuj yadav -dev"
app_description = "This app is a integration   of Frappe and react Front is created on react and backend  will work on frappe will add all the exoensesand create a dashboard of all the expenses"
app_email = "anuj@skyaitechnologies.com"
app_license = "MIT"
...
website_route_rules = [{'from_route': '/expensetracker/<path:app_path>', 'to_route': 'expensetracker'},]